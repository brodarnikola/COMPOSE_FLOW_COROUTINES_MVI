...
import com.example.mvi_compose.ui.CameraPreview
import com.example.mvi_compose.ui.PermissionRequester

//object ObjectDetectionView {

@Composable
fun ObjectDetectionScreen(viewModel: ObjectDetectionViewModel = hiltViewModel()) {
